                            ...
                            //2часть задание 1
                            {
                                for (int i = 1; i <= 9; i++) // Цикл для первого множителя
                                {
                                    ...
                                    //2часть задание 2
                                    {
                                        ...
                                        {
                                            180.40M, 200.25M, 70.80M, 110.20M, 125.30M,
                                            210.35M, 230.30M, 100.40M, 155.90M, 100.15M,
                                            200.15M, 180.10M, 125.75M, 170.75M, 145.95M,
                                            180.30M, 145.70M, 135.90M, 165.10M, 135.20M
                                        };
